...
from renku.service.config import CACHE_TEMPLATES_PATH
...
class Template(Model):
    ...
    url = TextField()
    ref = TextField()
    # directories = submodel with path, name, description, number
    # TODO: directories = Array()
    ...
    def abs_path(self):
        ...
        return CACHE_TEMPLATES_PATH / folder_name
